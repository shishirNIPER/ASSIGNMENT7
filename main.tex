...
\begin{lstlisting}
https://github.com/shishirNIPER/ASSIGNMENT7
\end{lstlisting}
%
Question taken from
\begin{lstlisting}
...
\end{align}
\begin{lstlisting}
https://github.com/ShishirNIPER/ASSIGNMENT7/blob/main/Minimum_dist.ipynb
\end{lstlisting}
The following code plots below Fig \ref{Graphical solution}
%	
\begin{lstlisting}
https://github.com/shishirNIPER/ASSIGNMENT7/blob/main/parabola_plot.ipynb
\end{lstlisting}
